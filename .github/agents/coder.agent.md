...
- Backend: FastAPI + Pydantic + SQLAlchemy + Polars + DuckDB.
...
These security practices are mandatory:
...
- use environment variables or settings for secrets, never hardcode them
- set appropriate CORS, CSP, and security headers
- handle file uploads safely: validate type, limit size, use generated filenames
