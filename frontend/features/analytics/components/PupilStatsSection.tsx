...
const METRIC_CONFIG = [
  ...
  },
  {
    ...
    borderCardClass: "border-emerald-100 dark:border-emerald-800/40",
    labelColorClass: "text-emerald-500",
    bgColorClass: "bg-gradient-to-br from-emerald-50 to-white dark:from-emerald-950/30 dark:to-transparent",
  },
  {
    key: "median" as const,
